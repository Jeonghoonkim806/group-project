...
<%
    ...
    if (title != null && description != null && category != null && tags != null && status != null && thumbnail_url != null && video_id != null && logo_url != null && uploader_id != null) {
	    ...
	    try {
	        ...
	        // video 테이블에 레코드 삽입
	        String insertSql = "INSERT INTO video (seq, title, description, uploader_id, category, tags, status, thumbnail_url, video_id, logo_url, views) VALUES (seq_video_no.NEXTVAL, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0)";
	        pstmt = conn.prepareStatement(insertSql, new String[] {"seq"});
	        pstmt.setString(1, title);
	        pstmt.setString(2, description);
	        pstmt.setString(3, uploader_id);
	        pstmt.setString(4, category);
	        pstmt.setString(5, tags);
	        pstmt.setString(6, status);
	        pstmt.setString(7, thumbnail_url);
	        pstmt.setString(8, video_id);
	        pstmt.setString(9, logo_url);
	        pstmt.executeUpdate();
