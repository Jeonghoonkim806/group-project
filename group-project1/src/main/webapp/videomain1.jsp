...
<body>
    ...
    <div class="YtBody">
        ...
        <div class="video_selection">
            ...
            <div class="videoActions">
			    ...
			    <span id="dislikeCount"><%= request.getAttribute("dislikeCount") %></span>
			</div>
    ...
    <script>
	    ...
	    fetch('getVideoCounts.jsp?filename=' + encodeURIComponent(videoId))
	        .then(response => response.json())
	        .then(data => {
	            document.getElementById('likeCount').innerText = `좋아요: ${data.likeCount}`;
	            document.getElementById('dislikeCount').innerText = `싫어요: ${data.dislikeCount}`;
	        })
