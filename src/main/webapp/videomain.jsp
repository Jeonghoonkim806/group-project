			  ...
			  <!-- Video info & Up next -->
			   <div class="infoAndUpNext">
                    <section class="info">
                        ...
                        <div class="view-day">
                            <div class="views"> views ·  days ago</div>
                        </div>
                        <ul class="actions">
                            <li>
                                <button id="likeButton" data-seq="" data-action="like">
                                    <i class="active fas fa-thumbs-up"></i><span id="likeCount"></span>
                                </button>
                            </li>
                            <li>
                                <button id="dislikeButton" data-seq="" data-action="dislike">
                                    <i class="fas fa-thumbs-down"></i><span id="dislikeCount"></span>
                                </button>
                            </li>
                            <li>
